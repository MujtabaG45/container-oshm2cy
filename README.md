...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oshm2cy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oshm2cy.containers.anotherwebservice.com/
...
```
git clone git@github.com:MujtabaG45/container-oshm2cy.git
cd container-oshm2cy
```
...
```
docker attach container-oshm2cy
```
